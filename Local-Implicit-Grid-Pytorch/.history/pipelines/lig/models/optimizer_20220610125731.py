...
class LIGOptimizer(object):
    ...
    def __init__(self,
        ...
        self.optim_steps = optim_steps = 1 
    ...
    def optimize_latent_code(self, points, point_values, occ_idxs, grid_shape):
        ...
        """
        device = self.device
        # !!! note that the latent was not relate to the point with random initial latent
    ...
    def optimize_step(self, optimizer, latent_grid, points, point_values):
        ...
        if self.indep_pt_loss:
            ...
            pred, weights = self.model.decode(latent_grid, point_samples) # call pipelines\lig\models\__init__.py decode (54)
            ...
            pred = self.model.decode(latent_grid, point_samples) # -> decoder model call
